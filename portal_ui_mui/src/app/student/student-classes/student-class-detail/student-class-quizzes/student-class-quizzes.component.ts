...
@Component({
  selector: 'app-student-class-quizzes',
  templateUrl: './student-class-quizzes.component.html',
  styleUrls: ['./student-class-quizzes.component.scss']
})
export class StudentClassQuizzesComponent implements OnInit {
  quizzes: Array<Quiz> = [];
