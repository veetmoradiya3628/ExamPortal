...
@Component({
  selector: 'app-teacher-create-student',
  templateUrl: './teacher-create-student.component.html',
  styleUrls: ['./teacher-create-student.component.scss']
})
export class TeacherCreateStudentComponent implements OnInit {
